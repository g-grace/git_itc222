...
select cs.servicekey, [dbo].[fx_servicegrantdifference](GrantAllocation, ServiceMaximum, cs.ServiceKey) from CommunityService cs join ServiceGrant sg on cs.servicekey = sg.servicekey
